...
import { PricePredict } from '../price_predict';

const idl = require('../price_predict.json');
...
export const DIVISOR = 1000; // use in percentage
export const DECIMAL = new BN('1000000000000', 10); // use when handling coin price
...
export const program = new Program(idl, PROGRAM_ID) as Program<PricePredict>;

export const getProgramStatePDA = () =>
	PublicKey.findProgramAddress([Buffer.from(PROGRAM_STATE_PDA_SEED, 'utf-8')], program.programId);
